...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2017 at 11:18 AM
...
CREATE TABLE `member` (
  ...
  `point_mem` varchar(50) COLLATE utf32_unicode_ci NOT NULL,
...
INSERT INTO `member` (`UserID`, `Username`, `Name`, `point_mem`, `email`, `Password`, `Status`) VALUES
(2, 'tao', 'tataya', '0', 'tao_tataya@gmail.com', '1234', 'ADMIN'),
(3, 'kubkib', 'natthakan Thongweera', '141', 'gibb_gibza@hotmail.co.th', 'kubkib', 'USER'),
